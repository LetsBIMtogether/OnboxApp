...
namespace ONBOXAppl
{
    ...
    partial class ONBOXApplication : IExternalApplication
    {
        ...
        private void CreateONBOXRibbon(UIControlledApplication application)
        {
            ...
            BitmapImage grid32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberGrid32.png", UriKind.Absolute));
            BitmapImage grid16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberGrid16.png", UriKind.Absolute));
            BitmapImage parking32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberParking32.png", UriKind.Absolute));
            BitmapImage parking16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberParking16.png", UriKind.Absolute));
            BitmapImage parkingDelete16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberDeleteParking16.png", UriKind.Absolute));
            BitmapImage parkingDelete32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberDeleteParking32.png", UriKind.Absolute));
            BitmapImage parkingBlock16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberBlockParking16.png", UriKind.Absolute));
            BitmapImage parkingBlock32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberBlockParking32.png", UriKind.Absolute));
            BitmapImage beams32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberBeams32.png", UriKind.Absolute));
            BitmapImage beams16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberBeams16.png", UriKind.Absolute));
            BitmapImage Column16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenumberColumns16.png", UriKind.Absolute));
            BitmapImage Column32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenameColumns32.png", UriKind.Absolute));
            BitmapImage Column16Select = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenameColumns16.png", UriKind.Absolute));
            BitmapImage Column32Select = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnRenameColumns32Select.png", UriKind.Absolute));
            BitmapImage BeamsFromBuilding16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnBeamsFromBuilding16.png", UriKind.Absolute));
            BitmapImage BeamsFromBuilding32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnBeamsFromBuilding32.png", UriKind.Absolute));
            BitmapImage createBeam16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnWallsToBeams16.png", UriKind.Absolute));
            BitmapImage createBeam32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnWallsToBeamsCreate32.png", UriKind.Absolute));
            BitmapImage createUpdate32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnWallsToBeamsUpdate32.png", UriKind.Absolute));
            BitmapImage createBeamsFromColumns16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnColumnsToBeams16.png", UriKind.Absolute));
            BitmapImage createBeamsFromColumns32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnColumnsToBeams32.png", UriKind.Absolute));
            BitmapImage ColumnsFromDwg16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnColumnsFromDWG16.png", UriKind.Absolute));
            BitmapImage ColumnsFromDwg32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnColumnsFromDWG32.png", UriKind.Absolute));
            BitmapImage ElementsCopy16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnBeamsCopyLevels16.png", UriKind.Absolute));
            BitmapImage ElementsCopy32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnBeamsCopyLevels.png", UriKind.Absolute));
            BitmapImage ElementsJoin16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnJoinMultiple16.png", UriKind.Absolute));
            BitmapImage ElementsJoin32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnJoinMultiple.png", UriKind.Absolute));
            BitmapImage ElementsSelectJoin16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnJoinSelectMultiple16.png", UriKind.Absolute));
            BitmapImage ElementsSelectJoin32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnJoinSelectMultiple.png", UriKind.Absolute));
            BitmapImage TopoFromPointCloud16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoFromPointCloud16.png", UriKind.Absolute));
            BitmapImage TopoFromPointCloud32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoFromPointCloud32.png", UriKind.Absolute));
            BitmapImage TopoFromDWG16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoFromDWG16.png", UriKind.Absolute));
            BitmapImage TopoFromDWG32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoFromDWG.png", UriKind.Absolute));
            BitmapImage TopoSlope16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoSlope16.png", UriKind.Absolute));
            BitmapImage TopoSlope32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnTopoSlope.png", UriKind.Absolute));
            BitmapImage ONBOX32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/onBox32.png", UriKind.Absolute));
            BitmapImage ONBOX16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/onBox16.png", UriKind.Absolute));
            BitmapImage INFO32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnInfo32.png", UriKind.Absolute));
            BitmapImage INFO16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnInfo16.png", UriKind.Absolute));
            BitmapImage privacy32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/privacy32.png", UriKind.Absolute));
            BitmapImage privacy16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/privacy16.png", UriKind.Absolute));
            //BitmapImage ProjectExamples16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnProjectExamplesFolder16.png", UriKind.Absolute));
            //BitmapImage ProjectExamples32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnProjectExamplesFolder.png", UriKind.Absolute));
            BitmapImage Package16 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnPackage16.png", UriKind.Absolute));
            BitmapImage Package32 = new BitmapImage(new Uri("pack://application:,,,/ONBOXAppl;component/ResourcesWPF/btnPackage32.png", UriKind.Absolute));
